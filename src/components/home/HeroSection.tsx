      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center">
        ...
        >
          ...
          <motion.p
            ...
            className="text-primary-foreground/80 text-lg md:text-xl lg:text-2xl font-light max-w-2xl mx-auto mb-10"
          >
          ...
          >
            <Link
              to="/contact"
              className="group flex items-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-full font-medium text-base transition-all duration-300 hover:shadow-glow hover:scale-105"
            >
              Book an Appointment
            ...
            <a
              ...
              className="flex items-center gap-2 bg-primary-foreground/10 backdrop-blur-sm border border-primary-foreground/30 text-primary-foreground px-8 py-4 rounded-full font-medium text-base transition-all duration-300 hover:bg-primary-foreground/20"
            >
              WhatsApp Now
            </a>
          </motion.div>
